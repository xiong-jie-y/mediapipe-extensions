...
bazel build -c opt --define=MEDIAPIPE_DISABLE_GPU=1 --action_env=PYTHON_BIN_PATH=/home/yusuke/miniconda3/envs/py37_ubuntu_vtuber/bin/python //pikapi:_framework_bindings.so
